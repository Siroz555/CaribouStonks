...
public final class NetworkEvents {
	 ...
	 */
	public static final Event<@NotNull ServerTick> SERVER_TICK = EventFactory.createArrayBacked(ServerTick.class, listeners -> () -> {
	 ...
	 */
	public static final Event<@NotNull GameJoin> GAME_JOIN_PACKET = EventFactory.createArrayBacked(GameJoin.class, listeners -> () -> {
	 ...
	 */
	public static final Event<@NotNull WorldTimeUpdate> WORLD_TIME_UPDATE_PACKET = EventFactory.createArrayBacked(WorldTimeUpdate.class, listeners -> () -> {
	 ...
	 */
	public static final Event<@NotNull PingResult> PING_RESULT = EventFactory.createArrayBacked(PingResult.class, listeners -> ping -> {
	 ...
	 */
	public static final Event<@NotNull ParticlePreReceived> PARTICLE_PRE_RECEIVED_PACKET = EventFactory.createArrayBacked(ParticlePreReceived.class, listeners -> particlePacket -> {
	 ...
	 */
	public static final Event<@NotNull ParticleReceived> PARTICLE_RECEIVED_PACKET = EventFactory.createArrayBacked(ParticleReceived.class, listeners -> particlePacket -> {
	 ...
	 */
	public static final Event<@NotNull PlaySound> PLAY_SOUND_PACKET = EventFactory.createArrayBacked(PlaySound.class, listeners -> soundPacket -> {
	 ...
	 */
	public static final Event<@NotNull ArmorStandUpdate> ARMORSTAND_UPDATE_PACKET = EventFactory.createArrayBacked(ArmorStandUpdate.class, listeners -> (entity, equipmentUpdate) -> {
	...
	public interface ArmorStandUpdate {
		void onArmorStandUpdate(@NotNull ArmorStand entity, boolean equipmentUpdate);
	}
}
