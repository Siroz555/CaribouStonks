...
import fr.siroz.cariboustonks.platform.rendering.gui.state.GradientRectGuiElementRenderState;
import fr.siroz.cariboustonks.platform.rendering.gui.state.QuadGuiElementRenderState;
...
public final class GuiRenderer {
	 ...
	 * <p>
	 * This method creates a {@code GradientRectGuiElementRenderState}.
	 *
	 ...
	 * <p>
	 * This method creates a {@code QuadGuiElementRenderState}.
	 *
	 * @param graphics  the {@code GuiGraphics}
	 ...
	 */
	public static void submitLinesFromPoints(@NonNull GuiGraphicsExtractor graphics, @NonNull Point @NonNull [] points, @NonNull Color color, int thickness) {
