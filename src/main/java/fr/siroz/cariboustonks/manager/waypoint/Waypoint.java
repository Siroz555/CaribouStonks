 ...
 *   <li>Via the {@link WaypointManager} which manages all registered waypoints</li>
 * </ul>
 *
 ...
 * <h2>Integration:</h2>
 * <pre>{@code
 * // Registering with WaypointManager
...
public final class Waypoint {
	 ...
	 * removes this Waypoint instance from the {@link WaypointManager}.
	 */
	public void destroy() {
	 ...
	 * into the {@link WaypointManager}, or simply constructing it for manual use.
	 */
	public static class Builder {
		 ...
		 * and registers it with the {@link WaypointManager}.
		 * <p>
		 * The method calls the {@code build()} method to create the {@link Waypoint} and then
		 * registers the resulting waypoint with the {@code WaypointManager} for further management.
		 *
