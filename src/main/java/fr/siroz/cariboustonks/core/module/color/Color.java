...
public record Color(int r, int g, int b, int a) {
	 ...
	 * @return la couleur obtenue
	 */
	public static @NonNull Color fromAwtColor(java.awt.@NonNull Color color) {
	 ...
	 */
	public float @NonNull [] asFloatComponents() {
	...
	public boolean equals(Object o) {
		if (!(o instanceof Color(int r1, int g1, int b1, int a1))) {
			return false;
		}

		return (this.r == r1 && this.g == g1 && this.b == b1 && this.a == a1);
	}
