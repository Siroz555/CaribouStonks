...
public final class AuctionStatistics {
	 ...
	 */
	public static @NonNull AuctionStatistics compute(@NonNull List<AuctionDataPoint> rawPoints) {
	...
	private static @NonNull DailyAggregate aggregateDay(LocalDate date, @NonNull List<AuctionDataPoint> points) {
	...
	private static PeriodStats computePeriod(
			@NonNull Map<LocalDate, DailyAggregate> dailies,
			LocalDate from,
			LocalDate to
	) {
