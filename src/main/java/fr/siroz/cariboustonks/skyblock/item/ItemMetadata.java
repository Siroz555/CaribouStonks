...
import fr.siroz.cariboustonks.skyblock.item.metadata.Books;
import fr.siroz.cariboustonks.skyblock.item.metadata.CosmeticInfo;
import fr.siroz.cariboustonks.skyblock.item.metadata.DrillInfo;
import fr.siroz.cariboustonks.skyblock.item.metadata.Enchantments;
...
import fr.siroz.cariboustonks.skyblock.item.metadata.PetInfo;
import fr.siroz.cariboustonks.skyblock.item.metadata.RodInfo;
import fr.siroz.cariboustonks.skyblock.item.metadata.SpecialAuctionInfo;
