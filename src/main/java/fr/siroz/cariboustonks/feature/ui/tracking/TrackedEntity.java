...
public record TrackedEntity(
		@NotNull ArmorStandEntity armorStand,
		int priority,
		long addedTime,
		boolean isSlayerBoss
) implements Comparable<TrackedEntity> {

	public TrackedEntity(ArmorStandEntity armorStand, int priority) {
		this(armorStand, priority, false);
	}

	public TrackedEntity(ArmorStandEntity armorStand, int priority, boolean isSlayerBoss) {
