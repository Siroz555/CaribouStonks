	...
	public ConfigCategory create() {
		return ConfigCategory.createBuilder()
				...
				.option(ButtonOption.createBuilder()
						...
						.text(Component.literal("Open"))
						.action((screen, _b) -> Minecraft.getInstance().setScreen(HudConfigScreen.create(screen)))
						.build())
				...
				.group(OptionGroup.createBuilder()
						...
						.option(ButtonOption.createBuilder()
								...
								.text(Component.literal("Open"))
								.action((screen, _v) -> Minecraft.getInstance().setScreen(KeyShortcutScreen.create(screen)))
								.build())
